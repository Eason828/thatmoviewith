...
@implementation UIScrollView (TMWAutoScroll)
...
- (void)scrollTick
{
    ...
    // Determines when the scroll resets back to the top
    CGFloat maximumYOffset = self.contentSize.height - 1400 + self.bounds.size.height;
